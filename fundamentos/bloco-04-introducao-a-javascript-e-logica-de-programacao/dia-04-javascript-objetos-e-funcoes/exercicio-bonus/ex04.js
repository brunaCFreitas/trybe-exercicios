...
let ultimoMoradorBloco2 = moradoresBloco2[moradoresBloco2.length - 1];
console.log(`O morador do bloco 2 de nome ${ultimoMoradorBloco2['nome']} ${ultimoMoradorBloco2['sobrenome']} mora no ${ultimoMoradorBloco2['andar']}º andar e no apartamento ${ultimoMoradorBloco2['apartamento']}.`)
