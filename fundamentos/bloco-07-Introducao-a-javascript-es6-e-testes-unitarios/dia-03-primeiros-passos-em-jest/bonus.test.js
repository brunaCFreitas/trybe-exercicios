...
describe('Testa a função searchEmployee', () => {
  ...
  it('Testa se searchEmployee(id, "specialities") retorna um array com todas as habilidades do id pesquisado', () => {
    const actual = searchEmployee('1256-4', 'specialities'); // cria u array com as habilidades
    expect(actual).toContain('Hooks', 'Context API', 'Tailwind CSS'); // verifica se o array possui esses elementos
  });
