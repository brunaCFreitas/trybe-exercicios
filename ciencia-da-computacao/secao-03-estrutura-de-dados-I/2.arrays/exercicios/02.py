# Exercício 2 - Em um jogo de baralho, as cartas estão
# representadas por um array numérico. Para iniciar o jogo,
# devemos embaralhar as cartas. Faremos isto dividindo uma
